 ...
 *                 format: binary
 *                 description: >-
 *                   Fichier CSV à importer (séparateur ',', en-têtes attendus :
 *                   Date,Montant,Source,TypeCompte,Commentaire).
 *                   - Date : format dd/MM/yyyy
 *                   - Montant : nombre (ex: 1234.56)
 *                   - Source : texte (ex: Salaire, CAF...)
 *                   - TypeCompte : Perso ou Conjoint (optionnel, défaut Perso)
