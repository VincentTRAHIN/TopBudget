...
describe('QuickActionsPanel Component', () => {
  describe('Rendering', () => {
    it('should render the panel with title and description', () => {
      ...
      expect(
        screen.getByText('Accès rapide aux fonctionnalités principales')
      ).toBeInTheDocument();
    });
    ...
    it('should render action descriptions', () => {
      ...
      expect(
        screen.getByText('Enregistrer une nouvelle dépense')
      ).toBeInTheDocument();
      expect(
        screen.getByText('Importer des dépenses depuis un fichier')
      ).toBeInTheDocument();
      expect(
        screen.getByText('Voir les statistiques détaillées')
      ).toBeInTheDocument();
      expect(
        screen.getByText('Enregistrer un nouveau revenu')
      ).toBeInTheDocument();
    });
    ...
    it('should render incentive message', () => {
      ...
      expect(
        screen.getByText(
          /Utilisez les raccourcis clavier pour un accès encore plus rapide/i
        )
      ).toBeInTheDocument();
    });
  });
  ...
  describe('Links and Hrefs', () => {
    it('should have correct href for "Ajouter une dépense"', () => {
      ...
      const addExpenseButton = screen.getByLabelText(
    ...
    it('should have correct href for "Importer CSV"', () => {
      ...
      const importButton = screen.getByLabelText(
        'Importer des dépenses depuis un fichier CSV'
      );
    ...
    it('should have correct href for "Statistiques"', () => {
      ...
      const statsButton = screen.getByLabelText(
        'Voir les statistiques financières détaillées'
      );
    ...
    it('should have correct href for "Ajouter un revenu"', () => {
      ...
      const addRevenueButton = screen.getByLabelText(
  ...
  describe('Accessibility', () => {
    it('should have proper aria-label for each action', () => {
      ...
      expect(
        screen.getByLabelText('Ajouter une nouvelle dépense')
      ).toBeInTheDocument();
      expect(
        screen.getByLabelText('Importer des dépenses depuis un fichier CSV')
      ).toBeInTheDocument();
      expect(
        screen.getByLabelText('Voir les statistiques financières détaillées')
      ).toBeInTheDocument();
      expect(
        screen.getByLabelText('Ajouter un nouveau revenu')
      ).toBeInTheDocument();
    });
