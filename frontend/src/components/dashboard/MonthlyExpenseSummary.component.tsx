      ...
      <div className="space-y-4 mb-6">
        ...
        <div className="flex items-center justify-between p-4 bg-green-50 border border-green-200 rounded-lg">
          <div>
            ...
            <p className="text-2xl font-bold text-green-600">{formatCurrency(revenusMois)}</p>
          </div>
          <div className="text-right">
            <div
              ...
              <span>
                {variationRevenus >= 0 ? "+" : ""}
                {formatCurrency(variationRevenus)}
              </span>
            </div>
        ...
        <div className="flex items-center justify-between p-4 bg-red-50 border border-red-200 rounded-lg">
          <div>
            ...
            <p className="text-2xl font-bold text-red-600">{formatCurrency(depensesMois)}</p>
          </div>
          <div className="text-right">
            <div
              className={`flex items-center gap-1 text-sm font-medium ${
              ...
              <span>
                {variationDepenses >= 0 ? "+" : ""}
                {formatCurrency(variationDepenses)}
              </span>
            </div>
            <p className="text-xs text-gray-500 mt-1">vs mois précédent</p>
          </div>
        ...
        <div
          className={`flex items-center justify-between p-4 border-2 rounded-lg ${
            soldeMois >= 0 ? "bg-indigo-50 border-indigo-300" : "bg-orange-50 border-orange-300"
          }`}>
          <div>
            <p className="text-sm font-medium text-gray-600">Solde</p>
            <p className={`text-2xl font-bold ${soldeMois >= 0 ? "text-indigo-600" : "text-orange-600"}`}>
