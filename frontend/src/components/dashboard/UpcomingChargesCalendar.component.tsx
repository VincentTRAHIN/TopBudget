      ...
      <div className="bg-white rounded-lg shadow-md p-6">
        ...
        <div className="text-center py-8">
          <p className="text-gray-500">
            Aucune charge fixe pour ce mois
          </p>
          <p className="text-gray-400 text-sm mt-2">
            Les charges récurrentes apparaîtront ici
          </p>
        </div>
      </div>
    );
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-medium text-gray-800">
                      {charge.description || charge.categorie.nom}
                    </p>
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-500">
                      Attendue : {new Date(charge.expectedDate).toLocaleDateString('fr-FR', {
                        day: 'numeric',
                        month: 'short',
                      })}
                    </p>
      ...
      {upcoming.length > 0 && (
        <div className="mt-4 p-3 bg-blue-50 border border-blue-200 rounded-lg">
          <p className="text-sm text-blue-800">
            💡 <span className="font-medium">{upcoming.length}</span> charge{upcoming.length > 1 ? 's' : ''} fixe{upcoming.length > 1 ? 's' : ''} à prévoir ce mois
          </p>
        </div>
      )}
    </div>
