...
import { DataType, TableAction, TableColumn } from "../table/table.types";
...
export function useColumns<T>({ onEdit, onDelete, refresh, endpoint }: UseColumnsProps<ICategorie | ICategorieRevenu>) {
