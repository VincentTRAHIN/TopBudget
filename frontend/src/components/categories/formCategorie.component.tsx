...
export default function FormCategorie({ existingCategorie, onClose, endpoint, refresh }: FormCategorieProps) {
      ...
      <Formik
        ...
        {({ isSubmitting }) => (
          <Form ref={formRef} className="space-y-4">
            <div>
              <label htmlFor="nom-cat" className="block text-sm font-medium text-gray-700 mb-1">
                Nom
              </label>
              <Field
                id="nom-cat"
            ...
            <div>
              <label htmlFor="desc-cat" className="block text-sm font-medium text-gray-700 mb-1">
                Description
              </label>
              <Field id="desc-cat" type="text" name="description" placeholder="Optionnel" className="input" />
