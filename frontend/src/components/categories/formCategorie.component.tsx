      ...
      >
          {({ isSubmitting }) => (
              <Form ref={formRef} className="space-y-4">
                  <div>
                     <label htmlFor="nom-cat" className="block text-sm font-medium text-gray-700 mb-1">Nom</label>
                      <Field
                          id="nom-cat"
                          type="text"
                          name="nom"
                  ...
                  <div>
                      <label htmlFor="desc-cat" className="block text-sm font-medium text-gray-700 mb-1">Description</label>
                      <Field
                          id="desc-cat"
                          type="text"
                          name="description"
                  ...
                  <div className="flex gap-4">
                     <button type="submit" disabled={isSubmitting} className="btn-primary flex-1">
                        {isSubmitting ? (existingCategorie ? "Modification..." : "Ajout...") : (existingCategorie ? "Modifier" : "Ajouter")}
                     </button>
                     {existingCategorie && (
                         <button type="button" onClick={onClose} className="bg-gray-300 text-gray-800 font-bold py-2 px-4 rounded-lg hover:bg-gray-400 transition duration-300 flex-1">
                            Annuler
                         </button>
                     )}
                  </div>
