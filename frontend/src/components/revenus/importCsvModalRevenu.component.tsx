...
export default function ImportCsvModalRevenu({
  ...
  const handleImport = async () => {
    ...
    try {
      const result = await fetcher<ImportResult>(importRevenusEndpoint, {
        method: 'POST',
        body: formData,
      });
        ...
        {importResult && (
          ...
          >
            ...
            >
              ...
              <li>Revenus importés : {importResult.importedCount}</li>
