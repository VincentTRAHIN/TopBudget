            ...
            <div className="md:col-span-1 bg-white p-6 rounded-lg shadow">
              ...
              <div className="relative mx-auto w-32 h-32 mb-2 group">
                ...
                <div className="absolute inset-0 bg-black bg-opacity-0 group-hover:bg-opacity-40 transition flex items-center justify-center rounded-full z-10 pointer-events-none">
                  <svg
                    className="text-white text-3xl opacity-0 group-hover:opacity-100 transition-opacity duration-200"
                    fill="none"
                    stroke="currentColor"
                    strokeWidth="2"
                    viewBox="0 0 24 24"
                  ...
                  >
                    <path
                      ...
                      d="M15.232 5.232l1.536 1.536A2 2 0 0120 8.268V17a2 2 0 01-2 2H6a2 2 0 01-2-2V8.268a2 2 0 01.586-1.414l1.536-1.536A2 2 0 017.768 4h8.464a2 2 0 011.414.586zM12 11a3 3 0 100 6 3 3 0 000-6z"
                    />
                  </svg>
                </div>
                {isUploadingAvatar && (
