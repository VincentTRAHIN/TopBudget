        ...
        <div className="space-y-8">
            ...
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
              <div className="flex items-center space-x-1 bg-gray-100 p-1 rounded-lg w-fit">
                <button
                  ...
                  className={`${selectedVue === "moi" ? "bg-white text-indigo-600 shadow-sm" : "text-gray-600 hover:text-gray-900"} flex items-center space-x-2 px-4 py-2 rounded-md text-sm font-medium transition-all duration-200 `}>
                ...
                {user?.partenaireId && typeof user.partenaireId === "object" && (
                  <button
                    ...
                    className={`${selectedVue === "partenaire" ? "bg-white text-indigo-600 shadow-sm" : "text-gray-600 hover:text-gray-900"} flex items-center space-x-2 px-4 py-2 rounded-md text-sm font-medium transition-all duration-200 `}>
                    <User className="w-4 h-4" />
          ...
          {showAddCategorieForm && (
            <FormCategorie
              ...
              endpoint={`${API_BASE_URL}/categories-revenu`}
