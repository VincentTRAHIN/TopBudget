...
test.describe("Dashboard Page", () => {
  ...
  test("should display the Dashboard page with all components", async ({ authenticatedPage }) => {
    ...
    const componentCount = await authenticatedPage
      .locator(
        '[data-testid*="expenses-sync"], [data-testid*="monthly-expense"], [data-testid*="upcoming-charges"], [data-testid*="quick-actions"]',
      )
      .count();
  ...
  test("Dashboard - should handle loading states gracefully", async ({ authenticatedPage }) => {
    ...
    const persistentErrors = await authenticatedPage
